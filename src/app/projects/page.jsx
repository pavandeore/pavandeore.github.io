...
const projects = [
  {
    name: 'Resuable SASS Template',
    description:
      'This is my first project that I have built when I started my journey, Resuable Template to launch your SAAS product.',
  ...
  },
  {
    ...
    description:
      'VS-CODE extension to generate Resuable Code Snippets and search for Articles.',
  ...
  //   name: 'Burnsnap',
  //   description:
  //     'The Social Media Platform to share Screenshot of Savage Reply in comment sections.',
  //   link: { href: '#', label: 'burnsnap' },
  //   // logo: logoOpenShuttle,
  // },
]
